...
class PromtsChain(BaseModel):
    validation: str = """
                        ...
                        Тебе нужно прочитать бухгалтерский вопрос и текст, в котором возможно содержится ответ.
                        Если в тексте есть ответ на вопрос, то нужно вернуть: "Есть ответ"
                        Если ответа нет, вернуть: "Нет ответа"
                        Вопрос: {}
                        Бухгалтерский текст: {}
                        """
